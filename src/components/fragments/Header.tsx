...
const Header = () => {
  ...
  return (
    ...
    >
      <div className="mx-auto w-10/12 max-w-[1605px] h-16 xl:h-20 2xl:h-28 lg:py-4">
        <div className="relative flex items-center w-full h-full justify-between max-md:py-auto">
