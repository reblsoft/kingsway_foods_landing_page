...
useEffect(() => {
  ...
  return (
    ...
    <section id="screenshots" className="flex-col flex w-full bg-[url('/images/screenshots.svg')] bg-cover max-md:bg-contain h-full items-center py-20 lg:gap-10.5"> 
      <div className="lg:gap-6 gap-2.5 grid text-center w-full">
        ...
        <h1 className="text-[#252b33]  text-[28px] md:text-4xl lg:text-5xl font-bold text-center">Experience the App</h1>
      </div>
